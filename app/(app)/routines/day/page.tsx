  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 text-sm text-[#51607c]">
        <Link href={`/routines/detail?id=${routine.id}`} className="inline-flex items-center gap-2 text-xs font-semibold text-[#4b5a72]">
...
export default function RoutineDayPage() {
  return (
    <Suspense fallback={<div className="p-6 text-center text-sm text-[#51607c]">Cargando dia...</div>}>
      <RoutineDayContent />
    </Suspense>
  );
}
